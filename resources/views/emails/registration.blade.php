...
<body>  
    <table>  
        <tr>  
            <td >  
                <p style="font-size: 25px;font-weight: 600;" >{{ get_setting('site_name') }}</p> 
                <div style="border-top:3px solid #000">
                </div>  
                <div style="font-size: 18px;font-weight: 400; color:black !important;">
                    <p>Hello</p>
                    This is a new registration on your website<br>
                    Business Name :<a href="https://pandbimports.com/admin/customers">{{$array['content']}} </a>
                    <br/><br />  
                    Thanks<br />  
                    P&B Imports 
                </div>
