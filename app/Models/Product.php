...
class Product extends Model
{
    ...
    protected $fillable = [
        ...
        'external_link_btn','refundable','earn_point','product_group_id','gemstone_size','gemstone_weight','product_weight','is_group_main_product','is_parent','is_price_show','system_type','is_new_arrival','list_product'
    ];
